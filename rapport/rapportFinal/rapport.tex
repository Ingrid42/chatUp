...
% diagramme modele domaine serveur 
% diagramme package serveur

% Paragraphe sur expliquer comment marche l'implémentation, comment se lance le projet

% Lister les tests qui ont été vraiment fait
